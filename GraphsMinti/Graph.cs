...
namespace GraphsMinti
{
    ...
    public class Graph {
        ...
        /// <returns></returns>
        public string ToMintyDotGraph(int startIdx, int destIdx, MintiNode[] mintiRez, bool showSingle, bool ShowAllMinPaths)
        {
            ...
            b.Append(ToMintyDot(startIdx, destIdx, mintiRez, showSingle, ShowAllMinPaths));
            b.Append("}");
            return b.ToString();
        }

        private string ToMintyDot(int startIdx, int destIdx, MintiNode[] mintiRez, bool showSingle, bool ShowAllMinPaths)
        {
                    ...
                    for (int j = 0; j < vertexCount; j++)
                    {
                        ...
                        if (pathCosts[i, j] >= 0)
                        {
                            ...
                            if (mintiRez[j] != null)
                            {
                                ...
                                else if (ShowAllMinPaths && mintiRez[j].otherPrevWayIdxs != null &&
                ...
                for (int i = 0; i < vertexCount; i++)
                {
                    ...
                    for (int j = 0; j < vertexCount; j++)
                    {
                        if (pathCosts[i, j] >= 0)
                        {
                            ...
                            else if (ShowAllMinPaths && mainRoadWayTable[i, j] == 2) b.Append(" color = magenta fontcolor = magenta]");
                            else b.Append("]");
                            b.AppendLine();
                        }
                    }
